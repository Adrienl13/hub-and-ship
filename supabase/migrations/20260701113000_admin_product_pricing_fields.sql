-- Admin product editor support for pricing engine fields.
--
-- Keeps the existing transactional admin_save_product_full contract, while
-- persisting the additive cost fields introduced by pricing phase 1.
