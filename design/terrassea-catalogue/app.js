...
import { adaptCatalogue, sanitizeCart, minimum } from './data.js'
...
if (root) {
  ...
  fetch('./api')
    ...
    .catch(() => {
      ...
      document.getElementById('catalogue-status').textContent =
        'Le catalogue est momentanément indisponible. Aucun produit ou prix de démonstration ne le remplace.'
    })
}
