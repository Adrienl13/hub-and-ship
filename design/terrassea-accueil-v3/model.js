...
export class Accueil {
  ...
  renderVals() {
    ...
    return {
      ...
      quotes: [
        {
          text: "“Nous voulions nos chaises dans le vert de la devanture. Elles sont arrivées exactement dans ce vert-là, cinquante d'un coup.”",
          who: 'Témoignage à remplacer',
          place: 'Restaurant, Paris 11e',
        },
        {
          text: "“Quatre-vingts fauteuils cordage pour le bord de piscine, livrés avant l'ouverture de saison. Le suivi a été simple du devis à la réception.”",
          who: 'Témoignage à remplacer',
          place: "Hôtel, Côte d'Azur",
        },
        {
          text: "“Pour un client exigeant, j'avais besoin d'un mobilier cohérent avec le projet. Le Studio nous a permis de valider les matières avant de commander.”",
          who: 'Témoignage à remplacer',
          place: "Architecte d'intérieur, Lyon",
        },
      ].map((q, i) => ({ ...q, delay: i * 0.12 + 's' })),
      proofs: [
        {
