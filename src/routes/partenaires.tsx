...
export const Route = createFileRoute('/partenaires')({
  head: () => ({
    meta: [
      { title: 'Programme partenaires — Container Club' },
      {
        name: 'description',
        content:
          'Devenez partenaire Container Club : apporteur d’affaires (8% de commission), revendeur agréé, grand compte ou distributeur exclusif. Candidature en 2 minutes, réponse sous 48 h.',
      },
      { property: 'og:title', content: 'Programme partenaires — Container Club' },
      {
        property: 'og:description',
        content:
          'Quatre statuts pour gagner sur le mobilier CHR sans les risques de l’import. Candidature en ligne, validation sous 48 h.',
      },
    ],
  }),
