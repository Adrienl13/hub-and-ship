...
export const Route = createRootRoute({
  ...
  head: () => ({
    ...
    links: [
      ...
      {
        rel: 'stylesheet',
        href: 'https://fonts.googleapis.com/css2?family=Source+Serif+4:ital,opsz,wght@0,8..60,200..900;1,8..60,200..900&family=Archivo:wght@500;600;700&family=JetBrains+Mono:wght@400;500;700&display=swap',
      },
    ],
    scripts: [
      {
