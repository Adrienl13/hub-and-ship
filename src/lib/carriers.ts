...
export const CARRIER_FAQ: ReadonlyArray<{ q: string; a: string }> = [
  ...
  },
  {
    ...
    a: "Écrivez-nous (contact@terrassea.com) en précisant votre code postal de livraison, le volume (m³) et la date d'arrivée prévue. On vous met en relation directement avec un partenaire qui couvre votre zone.",
  },
  {
