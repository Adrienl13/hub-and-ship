    ...
    content: (
      <>
        ...
        <LegalSection id="directeur" title="2. Directeur de la publication">
          <P>
            Adrien Laniez, en qualité de Président de Terrassea SAS, est le directeur de la
            publication du Site.
          </P>
        </LegalSection>
        ...
        <LegalSection id="hebergeur" title="3. Hébergement">
          <P>
            Le Site est hébergé sur l'infrastructure <Strong>Cloudflare Workers</Strong> :
          </P>
          <UL>
        ...
        <LegalSection id="pi" title="4. Propriété intellectuelle">
          ...
          <P>
            ...
            adaptation totale ou partielle, par quelque procédé que ce soit, est interdite sans
            autorisation écrite préalable de Terrassea SAS, à l'exception du droit de copie privée
            et de courte citation prévu par la loi.
          </P>
        </LegalSection>
        ...
        <LegalSection id="droit" title="7. Droit applicable et juridiction">
          <P>
            Le présent site et ses conditions d'utilisation sont soumis au droit français. Tout
            litige relatif à leur interprétation ou à leur exécution relève de la compétence
            exclusive des tribunaux du ressort de la Cour d'appel d'Aix-en-Provence, sauf
    ...
    content: (
      <>
        ...
        <LegalSection id="paiement" title="6. Modalités de paiement">
          ...
          <UL>
            ...
            <LI>
              ...
              validation du rapport de contrôle qualité SGS.
            </LI>
          </UL>
          <P>
        ...
        <LegalSection id="garanties" title="8. Garanties">
          ...
          <UL>
            ...
            <LI>
              ...
              couvrant les défauts de pièces et de structure dans le cadre d'un usage normal et
              professionnel.
            </LI>
          </UL>
          <P>
        ...
        <LegalSection id="droit-applicable" title="13. Droit applicable">
          <P>
            Les présentes CGV sont soumises au droit français à l'exclusion de la Convention de
            Vienne sur la vente internationale de marchandises (CVIM).
          </P>
        </LegalSection>
      </>
    ),
    ...
    content: (
      <>
        ...
        <LegalSection id="donnees" title="2. Données collectées">
          ...
          <UL>
            <LI>
              <Strong>Identification :</Strong> nom complet, fonction, raison sociale.
            </LI>
            <LI>
              <Strong>Contact :</Strong> email professionnel, téléphone, code postal, adresse de
              livraison.
            </LI>
            <LI>
        ...
        <LegalSection id="sous-traitants" title="4. Sous-traitants et destinataires">
          <P>Les données peuvent être communiquées aux sous-traitants suivants :</P>
          <UL>
            <LI>
              <Strong>Stripe Payments Europe Ltd.</Strong> — paiements (Irlande, conforme RGPD).
            </LI>
            <LI>
              <Strong>Cloudflare, Inc.</Strong> — hébergement, sécurité réseau (États-Unis,
        ...
        <LegalSection id="duree" title="5. Durée de conservation">
          <UL>
            <LI>
              Données de prospection commerciale : <Strong>3 ans</Strong> à compter du dernier
              contact.
            </LI>
            <LI>
              Données client actives : <Strong>durée de la relation commerciale + 3 ans</Strong>.
            </LI>
            <LI>
              Données comptables, factures : <Strong>10 ans</Strong> (obligation légale, article
              L123-22 du Code de commerce).
            </LI>
            <LI>
              Données de paiement : <Strong>13 mois maximum</Strong> côté Container Club ; durée
              conforme aux règles propres de Stripe pour les tokens.
            </LI>
            <LI>
              Journaux de connexion : <Strong>1 an</Strong> conformément à la LCEN.
            </LI>
          </UL>
        </LegalSection>
        ...
        <LegalSection id="modification" title="9. Modification de la politique">
          <P>
            La présente politique peut être mise à jour pour refléter des évolutions légales ou
            techniques. La date de dernière mise à jour figure en tête du document. Les
            modifications substantielles vous seront notifiées par email.
          </P>
        </LegalSection>
      </>
    ),
      ...
      <>
        ...
        <LegalSection id="liste" title="3. Liste détaillée des cookies déposés">
          ...
          <UL>
            ...
            <LI>
              <Strong>cc_consent</Strong> (Container Club, 6 mois) — mémorise vos choix de
              consentement cookies.
            </LI>
            <LI>
              <Strong>__stripe_mid</Strong> (Stripe, 1 an) — détection de fraude sur la page de
              paiement.
            </LI>
          </UL>
        </LegalSection>
        ...
        <LegalSection id="cas" title="2. Cas donnant lieu à remboursement intégral">
          <UL>
            ...
            <LI>
              ...
              partiel — remboursement au prorata de la ligne concernée.
            </LI>
            <LI>
              <Strong>Refus du SIRET au stade de l'acompte 27 %</Strong> — Container Club
              n'autorisant que les Acheteurs professionnels.
            </LI>
            <LI>
              <Strong>Défaut majeur non corrigeable</Strong> détecté avant expédition.
            </LI>
          </UL>
        </LegalSection>
