...
/**
 * Channel coefficients applied to the public direct price. These MUST match
 * the defaults of the `pricing_parameters` engine (see the coherence unit
 * test against `channel-economics.ts` — admin-only module) and the
 * `channel_coefficients` fallback seed in the migration.
 *
