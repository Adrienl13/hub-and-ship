      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <Reveal className="grid gap-8 md:grid-cols-[1fr_auto] md:items-end">
          <div className="max-w-2xl">
            <div className="label-eyebrow text-[color:var(--ember)]">Prêt à rejoindre</div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-[color:var(--ink-soft)]">
              Les frais de réservation bloquent votre place. Le complément n'est appelé
              que lorsque le container atteint son seuil de remplissage.
            </p>
            <div className="mt-5 flex flex-wrap gap-2 text-xs text-foreground/75">
