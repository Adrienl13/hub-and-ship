                    ...
                    <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs">
                      <label className="flex items-center gap-1.5">
                        ...
                        <input
                          ...
                          className="h-9 w-20 rounded-sm border border-[color:var(--border-strong)] bg-[color:var(--paper)] px-2 text-sm font-semibold tabular-nums focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--ink)]"
                        />
                      </label>
                ...
                <div className="mt-2 flex gap-2">
                  {onEditQuantity && !compact && (
                    <button
                      ...
                      className="inline-flex min-h-[40px] items-center rounded-sm border border-[color:var(--sand-deep)] px-3 text-xs font-medium hover:border-[color:var(--ink)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--ink)]"
                    >
                      Revoir
                    </button>
                  )}
                  <button
                    ...
                    className="inline-flex min-h-[40px] items-center gap-1.5 rounded-sm border border-[color:var(--sand-deep)] px-3 text-xs font-medium text-[color:var(--stamp)] hover:border-[color:var(--stamp)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--ink)]"
                  >
      ...
      {items.length > 0 && (
        <div className="border-t border-[color:var(--sand-deep)] pt-3 text-sm">
          <div className="flex items-baseline justify-between">
            ...
            <span className="font-display text-lg font-bold tabular-nums">{formatEUR(totalHt)} HT</span>
          </div>
