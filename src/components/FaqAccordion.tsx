const FAQ = [
  ...
  },
  {
    ...
    a: "Container Club (Terrassea SAS) est l'importateur officiel : numéro EORI FR, déclaration douanière, TVA autoliquidée, conformité produit (CE, REACH, classement feu). Vous recevez une facture HT française avec TVA 20% en sus, parfaitement déductible.",
  },
  {
