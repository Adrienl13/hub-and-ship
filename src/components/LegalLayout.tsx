...
export const LEGAL_PAGES = [
  { slug: "mentions-legales", label: "Mentions légales", short: "Éditeur & hébergement" },
        ...
        <div className="grid gap-10 lg:grid-cols-12">
          ...
          <aside className="lg:col-span-3">
            <nav className="sticky top-20 space-y-1">
              <div className="label-eyebrow mb-3 text-muted-foreground">Documents légaux</div>
          ...
          <main className="lg:col-span-9">
            <header className="border-b border-[color:var(--sand-deep)] pb-6">
              <div className="label-eyebrow text-[color:var(--ember)]">Document légal</div>
