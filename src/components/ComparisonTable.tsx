    ...
    <section className="border-t border-[color:var(--sand-deep)]">
      <div className="mx-auto max-w-7xl px-6 py-20">
        <Reveal className="mb-10 max-w-2xl">
          <div className="label-eyebrow text-[color:var(--ember)]">Comparatif</div>
          ...
          <p className="mt-3 text-sm leading-relaxed text-[color:var(--ink-soft)]">
            Le modèle assume moins de stock immédiat, mais plus de transparence sur le
            prix, la conformité et l'origine.
          </p>
        </Reveal>
