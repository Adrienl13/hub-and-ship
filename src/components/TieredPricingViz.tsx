  ...
  return (
    <div className="rounded-md border border-[color:var(--sand-deep)] bg-card p-3 text-xs">
      <div className="mb-3 flex items-start justify-between gap-3">
        <div>
          <div className="label-eyebrow text-muted-foreground">Remise quantité</div>
      ...
      <div className="mb-3 grid grid-cols-2 gap-2">
        <div className="rounded-sm bg-[color:var(--sand-soft)] px-2.5 py-2">
          <div className="label-eyebrow text-muted-foreground">Quantité panier</div>
          <div className="mt-0.5 font-display text-base font-semibold tabular-nums">
            {totalUnits} unités
          </div>
        </div>
        <div className="rounded-sm bg-[color:var(--sand-soft)] px-2.5 py-2">
          <div className="label-eyebrow text-muted-foreground">Remise active</div>
          <div className="mt-0.5 font-display text-base font-semibold tabular-nums">
            {discountStatus.discountPercent}%
          </div>
        </div>
