  ...
  chair: [
    {
      ...
      quote:
        'Bonne tenue en terrasse, empilage pratique et finition cohérente avec les photos.',
    },
    {
      ...
      quote:
        'Produit reçu conforme. Quelques cartons marqués, mais mobilier intact au contrôle.',
    },
  ],
  armchair: [
    {
      ...
      quote:
        "Assise confortable, coussins faciles à retirer et rendu premium pour l'espace piscine.",
    },
    {
      ...
      quote:
        'Bon rapport qualité/prix, surtout sur une commande groupée. Livraison bien documentée.',
    },
  ],
  table: [
    {
      ...
      orderSize: '24 tables',
      quote:
        "Plateaux faciles à nettoyer, pieds stables et montage rapide pour l'équipe.",
    },
    {
      ...
      orderSize: '30 tables',
      quote:
        "La finition HPL tient bien au soleil. Les fiches techniques ont aidé pour valider l'achat.",
    },
  ],
  bench: [
    {
      ...
      orderSize: '55 bancs',
      quote:
        'Structure robuste et visuel conforme. À prévoir à deux personnes pour la manutention.',
    },
    {
      ...
      orderSize: '50 bancs',
      quote:
        "Très bon rendu dans les zones d'accueil extérieur, facile à coordonner avec les assises.",
    },
  ],
}
