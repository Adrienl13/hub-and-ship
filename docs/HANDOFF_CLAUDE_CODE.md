...
| Factures/devis       | P1 (partiel) | **FAIT 2026-06-07** : recapitulatif imprimable (PDF navigateur) `/account/reservations/{id}/document` — lignes, totaux HT/eco/TVA/TTC, echeancier frais/acompte/solde, deja regle. Reste : facture legale numerotee (table `invoices`, numerotation, mentions), historique. |
