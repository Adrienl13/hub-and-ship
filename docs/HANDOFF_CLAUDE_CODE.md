...
| ----------------- | -------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Catalogue         | Fonctionnel, cartes portrait, panier, 3D lazy, filtres avances, **mode comparaison desktop (2026-06-08)** | P1       | Brancher donnees Supabase live, ~~mode comparaison~~ (fait : selection jusqu'a 4 produits + table de specs), ~~filtres avances~~ (fait), sauvegarde selection, import/export catalogue admin, vrais visuels et documents. |
