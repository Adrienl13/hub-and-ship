...
| ----------------- | -------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Catalogue         | Fonctionnel, cartes portrait, panier (persiste localStorage), 3D lazy, filtres avances, comparaison desktop, **partage de selection par lien `?panier=` (2026-06-08)** | P1       | Brancher donnees Supabase live, ~~mode comparaison~~ / ~~filtres avances~~ / ~~sauvegarde-partage selection~~ (faits), import/export catalogue admin, vrais visuels et documents. |
