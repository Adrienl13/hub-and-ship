...
const STUDIO_INTERNAL_COLUMNS = ['notes', 'note', 'created_by', 'updated_by', 'confirmed_by', 'validated_by', 'validated_at', 'rejected_reason', 'embedding', 'source_media_id', 'evidence', 'metadata', 'reviewed_by', 'provenance', 'verified_by', 'verified_at', 'factory_ref', 'supplier', 'source_asset_uri', 'internal_notes']
...
const PUBLIC_SURFACES = [
  { view: 'studio_visual_library_public', columns: ['public_ref', 'family', 'label', 'thumbnail', 'image', 'tag', 'active', 'color_customization', 'color_zones'], optional: true },
  { view: 'studio_visual_associations_public', columns: ['product_id', 'public_ref', 'status', 'palette_refs'], optional: true },
...
const INTERNAL_TABLES = [
  'studio_visual_library', 'studio_visual_sources', 'studio_visual_associations', 'studio_visual_configurations',
